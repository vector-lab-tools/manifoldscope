...
Projection-Distortion Meter. Phase 1b will add Critique-core operations
(ideological topography, hegemonic gravity, normative transition,
dissensus detector, grammatical ideology probe).
"""
...
app = FastAPI(title="Manifoldscope Backend", version="0.1.0")
