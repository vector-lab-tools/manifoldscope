      ...
      <div className="mx-auto max-w-6xl px-6 py-8">
        ...
        {tab === "critique" && (
          <div className="space-y-6">
            <Intro
              title="Critique"
              text="Ideological investigation, interpretive, readings backed by geometric evidence. Phases 1b and 2a ship ten operations: Ideological Topography, Hegemonic Gravity Map, Market-Colonisation Index, Normative Transition Probe, Dissensus Detector, Grammatical Ideology Probe, Training-Data Fingerprinting, Temporal Sedimentation, Synonymic Erosion, and Metric Archaeology. Every Critique finding renders alongside an independent Measure attestation on the same sample."
            />
            <CritiquePanel />
          </div>
        )}
